                ...
                <div class="contact-info">
                    ...
                    <div class="single-info">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" x="0" y="0"
                                viewBox="0 0 473.806 473.806" style="enable-background:new 0 0 512 512"
                    ...
                    <div class="single-info">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" x="0" y="0"
                                viewBox="0 0 443.294 443.294" style="enable-background:new 0 0 512 512"
                                xml:space="preserve" class="">
                                <g>
                                    <path
...
<!--========== Google Map Section ==========-->
@if(!empty($setting?->map_embed_url))
