...
<div class="mc-bar">
    <form action="{{ route('admin.lab-orders.index') }}" method="GET" class="flex flex-1 items-center gap-2.5">
        ...
        <select name="status" class="rounded-lg border border-line bg-white px-3 py-2.5 text-[14px] text-ink outline-none focus:border-teal" onchange="this.form.submit()">
