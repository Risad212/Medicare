...
<div class="mc-head">
    <div>
        ...
        <h1 class="mc-title">New blood <em>group</em></h1>
        <p class="mc-sub">Register a type such as O+ or AB- to label donations.</p>
    </div>
</div>
...
<form action="{{ route('admin.blood-groups.store') }}" method="POST">
    ...
    <div class="mc-grid">
        <aside class="mc-side">
            <div class="mc-avbig">BG</div>
            <div class="k">New record</div>
            <h2>Unsaved type</h2>
            <p>Blood groups are shared by donors, donations, requests and issues.</p>
            <ul class="mc-steps">
        ...
        <div>
            <section class="mc-sec">
                ...
                <div class="mc-sec-bd">
                    <div class="mc-f full">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="e.g. O+" value="{{ old('name') }}" maxlength="10">
            ...
            <section class="mc-sec">
                <div class="mc-sec-hd"><span class="no">02</span><h3>Visibility</h3><p>Disabled groups can be kept around without accepting new records.</p></div>
                <div class="mc-sec-bd">
                    <div class="mc-f">
                        <label>Status</label>
            ...
            <div class="mc-formacts">
                <button type="submit" class="mc-btn"><i class="bi bi-save"></i> Save blood group</button>
