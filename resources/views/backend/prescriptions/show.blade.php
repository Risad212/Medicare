...
<div class="mc-head">
    ...
    <div class="mc-head-acts">
        <a href="{{ route('admin.prescriptions.index') }}" class="mc-btn ghost">Back to list</a>
        <a href="{{ route('admin.prescriptions.pdf', $prescription) }}" class="mc-btn ghost"><i class="bi bi-file-earmark-pdf"></i> PDF</a>
